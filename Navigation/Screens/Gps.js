...
import { SendPushNotification } from './Notification'; // Import the SendPushNotification function
...
const GPSTracker = () => {
    ...
    const calculateDistanceBetweenPoints = (lat1, lon1, lat2, lon2) => {
        ...
        const a = Math.sin(Dq / 2) * Math.sin(Dq / 2) + Math.cos(q1) * Math.cos(q2) * Math.sin(Dr / 2) * Math.sin(Dr / 2);
